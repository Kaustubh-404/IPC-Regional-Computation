    ...
    <div className="h-full bg-gray-200 ">
        <div className="bg-white rounded-lg shadow-xl ">
            {/* <div x-data={{ openSettings: false }} className="absolute right-12 mt-4 rounded">
                <button onClick={() => openSettings = !openSettings} className="border border-gray-400 p-2 rounded text-gray-300 hover:text-gray-300 bg-gray-100 bg-opacity-10 hover:bg-opacity-20" title="Settings">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div x-show={{ openSettings: false }} className="bg-white absolute right-0 w-40 py-2 mt-1 border border-gray-200 shadow-2xl" style={{ display: 'none' }}>
                    <div className="py-2 border-b">
                        <p className="text-gray-400 text-xs px-6 uppercase mb-1">Settings</p>
                        <button onClick={() => openSettings = !openSettings} className="w-full flex items-center px-6 py-1.5 space-x-2 hover:bg-gray-200">
            ...
            <div className="flex flex-col items-center -mt-20">
                <img src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=880&q=80" className="w-40 border-4 border-white rounded-full"/>
                <div className="flex items-center space-x-2 mt-2">
                    <p className="text-2xl">Arthur Melo</p>
                ...
                <p className="text-gray-700">authurmelo@example.com</p>
                <p className="text-sm text-gray-500">New York, USA</p>
            </div>
            <div className="flex-1 flex flex-col items-center lg:items-end justify-end px-8 mt-2">
                <div className="flex items-center space-x-4 mt-2">
                    <button className="flex items-center bg-gray-800 hover:bg-gray-700 text-gray-100 px-4 py-2 rounded text-sm space-x-2 transition duration-100">
...
<svg className="w-5 h-5" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 506.86 506.86">
    ...
    <path style={{ fill: '#fff' }} d="M352.08,326.69l11.23-73.26H293V205.89c0-20,9.81-39.58,41.3-39.58h31.95V104s-29-5-56.73-5c-57.88,0-95.72,35.08-95.72,98.6v55.83H149.48v73.26h64.35V503.78a256.11,256.11,0,0,0,79.2,0V326.69Z"></path>
</svg>
            ...
            <div className="flex flex-col w-full 2xl:w-2/3">
                <div className="flex-1 bg-white rounded-lg shadow-xl p-8">
                    ...
                    <p className="mt-2 text-gray-700">Arthur is leveraging the Filecoin network to provide storage solutions. By participating as a storage provider on Filecoin, Arthur offers decentralized storage services to clients, utilizing the network's infrastructure and technology to securely store and manage data. With Filecoin's decentralized storage marketplace, Arthur can offer scalable and reliable storage solutions while contributing to the growth and decentralization of the Filecoin ecosystem.</p>
                </div>
                <div className="flex-1 bg-white rounded-lg shadow-xl mt-4 p-8">
